...
namespace TestsProyecto
{
    ...
    public class TestInteracciones
    {
        ...
        public void CorreoElectronico_RegistrarEnRepositorio()
        {
            ...
            var correo = new CorreoElectronico("1", "20-10-25", "Tema1", true, "c1", "v1", new List<Comentario>(), "enviado", "asunto", "texto");
        ...
        {
            var repo = new RepositorioInteracciones();
            var mensaje = new Mensaje("2", "20-10-25", "hola", true, "c2", "v2", new List<Comentario>(), "enviado", "texto", "WhatsApp");
            var reunion = new Reunion("3", "21-10-25", "Reu", true, "c3", "v3", new List<Comentario>(), "Oficina");
        ...
        {
            var inter = new Mensaje("4", "19-10-25", "Tema", true, "c4", "v4", new List<Comentario>(), "recibido", "txt", "sms");
            inter.CambiarEstado(true);
        ...
        {
            var repo = new RepositorioInteracciones();
            var i1 = new CorreoElectronico("1", "20-10-25", "A", true, "c1", "v1", new List<Comentario>(), "enviado", "a", "b");
            var i2 = new Mensaje("2", "19-10-25", "B", false, "c2", "v2", new List<Comentario>(), "enviado", "t", "wa");
            repo.Agregar(i1);
            repo.Agregar(i2);
        ...
        {
            var repo = new RepositorioInteracciones();
            repo.Agregar(new Mensaje("1", System.DateTime.Now.ToString("dd-MM-yy"), "T", true, "c", "v", new List<Comentario>(), "recibido", "c", "c"));
